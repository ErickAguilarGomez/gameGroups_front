        ...
        <div class="text-center mb-4">
          ...
          <p class="text-muted">Completa el formulario para registrarte</p>
              ...
              <b-form @submit.prevent="handleSubmit">
                ...
                <b-form-group label="Fecha de Nacimiento" label-for="birthdate" class="mb-3">
                  <b-input-group>
                    <template #prepend>
                      <b-input-group-text>
                ...
                <!-- Red Social (Opcional) -->
                <b-form-group label="Red Social (Opcional)" label-for="social_network" class="mb-3">
                ...
                <b-form-group label="Contraseña" label-for="password" class="mb-3">
                  ...
                  <b-form-text>La contraseña debe tener al menos 8 caracteres</b-form-text>
                </b-form-group>

                <!-- Confirmar Contraseña -->
                <b-form-group label="Confirmar Contraseña" label-for="password_confirmation" class="mb-3">
                  <b-input-group>
                    <template #prepend>
                      <b-input-group-text>
                        <IconLock :size="20" />
                    ...
                    />
                    <template #append>
                      <b-button variant="outline-secondary" @click="showPasswordConfirm = !showPasswordConfirm">
