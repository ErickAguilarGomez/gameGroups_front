...
export const auth = {
  csrf: (): Promise<AxiosResponse> => 
    backendApi.get('/sanctum/csrf-cookie'),
  ...
  register: (data: {
    ...
    backendApi.post('/register', data),

  logout: (): Promise<AxiosResponse> => 
    backendApi.post('/logout'),

  me: (): Promise<AxiosResponse> => 
    backendApi.get('/api/users/me'),

  updatePhoto: (photo_url: string): Promise<AxiosResponse> =>
    backendApi.post('/api/users/photo', { photo_url }),

  createToken: (email: string, password: string, tokenName: string): Promise<AxiosResponse> =>
    backendApi.post('/api/tokens/create', { email, password, token_name: tokenName }),
}
...
export const cloudinary = {
  getSignature: (folder: string = 'user_photos'): Promise<AxiosResponse> =>
    backendApi.post('/cloudinary/signature', { folder }),
}
...
export const tokens = {
  list: (): Promise<AxiosResponse> => 
    backendApi.get('/api/tokens'),

  revoke: (): Promise<AxiosResponse> => 
    backendApi.post('/api/tokens/revoke'),
...
export const photos = {
  pending: (): Promise<AxiosResponse> => 
    backendApi.get('/api/photos/pending'),
  ...
  stats: (): Promise<AxiosResponse> => 
    backendApi.get('/api/photos/stats'),
}
...
export const registrations = {
  ...
  approve: (userId: number, photoDecision: 'approve' | 'reject' = 'approve', groupId?: number): Promise<AxiosResponse> => 
...
export const groups = {
  all: (): Promise<AxiosResponse> => 
    backendApi.get('/api/groups'),

  create: (data: { name: string; group_img_url?: string }): Promise<AxiosResponse> => 
    backendApi.post('/api/groups', data),

  show: (id: number): Promise<AxiosResponse> => 
    backendApi.get(`/api/groups/${id}`),

  update: (id: number, data: { name?: string; group_img_url?: string }): Promise<AxiosResponse> => 
    backendApi.put(`/api/groups/${id}`, data),
  ...
  removeUser: (groupId: number, userId: number, banReason: string): Promise<AxiosResponse> => 
    backendApi.post(`/api/groups/${groupId}/remove`, { user_id: userId, ban_reason: banReason }),
